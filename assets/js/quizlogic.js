...
function init() {
    ...
    // creates button to start the game
    let startjqueryQuiz = document.createElement("button");
    startjqueryQuiz.setAttribute("id", "startjqueryQuiz");
    startjqueryQuiz.setAttribute("class", "btn btn-secondary");
    startjqueryQuiz.textContent = "Start JQuery Quiz";

    mainEl.appendChild(heading);
    mainEl.appendChild(instructions);
    mainEl.appendChild(startJsQuiz);
    mainEl.appendChild(startjqueryQuiz);
    ...
    startjqueryQuiz.addEventListener("click", function () {
        quizType = "JQuery";
        playQuiz(jqueryQuestions);
    });
}
